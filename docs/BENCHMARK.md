...
- 复跑 Linux VM 构建、CTest、API smoke、MySQL / Redis 集成测试、Redis 不可用 fallback 和异常场景脚本。
- 汇总 v1.4 已修复问题、环境特定问题、剩余风险和后续版本归属。
- 明确 Redis 连接池、MySQL 连接池参数矩阵、连接等待超时和限流是否进入后续版本。
- 更新 `docs/ROADMAP.md`、`docs/BENCHMARK.md` 和 `docs/BUGS.md`，完成 v1.4 收口。
