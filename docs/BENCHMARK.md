...
- v1.6 版本：基于 `d601e7d` 的 `codex/v1.6-reliability` 当前工作区。
- 工具：`hey v0.1.5`。
...
| `GET /api/health` | v1.6 worktree | 82542.30 / 86505.19 / 88731.14 | 86505.19 | 0.000164s | 0.0010s–0.0012s | 0.0022s | 0.00% |
| `GET /s/{code}` | `main` | 67659.00 / 66006.60 / 78003.12 | 67659.00 | 0.000219s | 0.0014s–0.0016s | 0.0024s–0.0029s | 0.00% |
| `GET /s/{code}` | v1.6 worktree | 74710.50 / 72176.11 / 74487.90 | 74487.90 | 0.000196s | 0.0014s–0.0015s | 0.0024s–0.0027s | 0.00% |
