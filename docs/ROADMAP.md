...
| v1.6 | 本地收口已完成，待云端 CI | 可靠性与流量保护 | Redis 限流、降级策略、健康语义、保护性测试 |
...
当前状态：v1.6.0-v1.6.6 实现、本地回归和干净克隆验证已完成；云端 CI 待开发分支推送后确认。
